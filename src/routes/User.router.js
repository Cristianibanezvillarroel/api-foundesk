...
{ postUser, login, updateUser, updatePassword, verifyUser, requestResetPassword, requestResetPasswordConfirm, confirmUserPin, getStaffUsers, updateUserIsStaff, updateUserIsStaffDefault, getStaffByUser, updateUserParentUserId, uploadUserFiles, downloadUserFile, downloadUserFileById, deleteUserFiles, getUserByEmail } = require('../controllers/User.controller'),
...
router.get('/files/:fileType/:userId', auth, downloadUserFileById)
