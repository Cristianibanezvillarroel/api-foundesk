...
{ postUser, login, updateUser, updatePassword, verifyUser, requestResetPassword, requestResetPasswordConfirm, confirmUserPin, getStaffUsers, updateUserIsStaff, updateUserIsStaffDefault, getStaffByUser, updateUserParentUserId, uploadUserFiles, downloadUserFile, getUserByEmail } = require('../controllers/User.controller'),
